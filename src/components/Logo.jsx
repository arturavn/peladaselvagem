export default function Logo({ size = 'md' }) {
  ...
  return (
    <div className="logo">
      ...
      >
        {/* Outer circle */}
        <circle cx="16" cy="16" r="14.5" stroke="#FF5500" strokeWidth="1.5" />
        {/* Pentagon center */}
        <path
        ...
        />
        {/* Panel lines */}
        <path d="M16 9.5L11 6.8M16 9.5l5 -2.7" stroke="#FF5500" strokeWidth="1" opacity="0.4" />
        <path d="M18.8 18l3.8 2.2M13.2 18l-3.8 2.2" stroke="#FF5500" strokeWidth="1" opacity="0.4" />
        <path d="M14.3 18h3.4l1 4.2M14.3 18l-1 4.2" stroke="#FF5500" strokeWidth="1" opacity="0.4" />
        {/* Outer panels */}
        <path
