  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      ...
      <svg width={iconW} height={iconH} viewBox="0 0 38 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        {/* Football */}
        <circle cx="19" cy="21" r="7.5" stroke="#00E64D" strokeWidth="1.2" opacity="0.9"/>
        {/* Pentagon */}
        <path
        ...
        />
        {/* Ball panels */}
        <path d="M19 16.2l-2.8-1.6M19 16.2l2.8-1.6" stroke="#00E64D" strokeWidth="0.8" opacity="0.5" strokeLinecap="round"/>
        <path d="M21.7 18.1l2.5 1.4M16.3 18.1l-2.5 1.4" stroke="#00E64D" strokeWidth="0.8" opacity="0.5" strokeLinecap="round"/>
        <path d="M20.7 21.3l1.6 2.8M17.3 21.3l-1.6 2.8" stroke="#00E64D" strokeWidth="0.8" opacity="0.5" strokeLinecap="round"/>
      </svg>
