...
export const api = {
  ...
  resolveEmpateSwap: (priorityTeamId)              => request('POST', '/actions/resolve-empate-swap', { priorityTeamId }),
  ...
  removeMatchPlayer:  (playerName, remaining, continues) => request('POST', '/actions/remove-match-player', { playerName, remaining, continues }),
